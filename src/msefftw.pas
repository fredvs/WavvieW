...
const
{$ifdef mswindows}
 fftwlib: array[0..1] of filenamety = ('lib\fftw3.dll','lib\libfftw3-3.dll');
{$else}
 fftwlib: array[0..1] of filenamety = ('lib/libfftw3.so.3','lib/libfftw3.so');
{$endif}
}

const
{$ifdef mswindows}
 fftwnamelib = 'libfftw3-3.dll' ;
{$else}
 fftwnamelib = 'libfftw3.so.3' ;
{$endif}

var
fftwlib: array of filenamety;
...
procedure fftw_init(directorylib: filenamety);
...
begin
setlength(fftwlib,1);
fftwlib[0] := directorylib + fftwnamelib;
