...
type
  ...
  public
    ...
    function Execute(dialogkind: filedialogkindty = fdk_open): modalresultty;
      overload;
    ...
    function Execute(const dialogkind: filedialogkindty; const aoptions: filedialogoptionsty): modalresultty;
      overload;
    function Execute(var avalue: filenamety; dialogkind: filedialogkindty = fdk_open): Boolean;
      overload;
...
begin
  ...
  fcaptionopen := 'Choose a wav, ogg or flac audio file';
...
function tfiledialogcontroller.Execute(dialogkind: filedialogkindty = fdk_open): modalresultty;
begin
  if dialogkind = fdk_none then
...
function tfiledialogcontroller.Execute(var avalue: filenamety; dialogkind: filedialogkindty = fdk_open): Boolean;
begin
  if dialogkind = fdk_none then
    if fdo_save in foptions then
      dialogkind := fdk_save
...
begin
  ...
  aowner.controller.fcaptionopen := 'Choose a wav, ogg or flac audio file';
